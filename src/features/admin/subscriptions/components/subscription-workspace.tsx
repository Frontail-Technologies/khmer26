...
export function SubscriptionWorkspace({
  ...
  return (
    <div className="space-y-3.5 sm:space-y-4">
      <div className="border-b border-border/60 bg-muted/20 px-3 sm:px-4 pt-2.5 overflow-x-auto no-scrollbar rounded-xl bg-card border border-border/70 shadow-2xs">
